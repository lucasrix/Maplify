    ...
    private func suggestionToShow(searchTerm : String) -> String
    {
        ...
        for suggestion in self.suggestions
        {
                ...
                suggestion.lowercaseString.hasPrefix(searchTerm.lowercaseString))
            {
                ...
                let range = suggestion.startIndex.advancedBy(searchTerm.characters.count)..<suggestion.endIndex
                suggestionToReturn = suggestionToReturn + suggestion.substringWithRange(range)
